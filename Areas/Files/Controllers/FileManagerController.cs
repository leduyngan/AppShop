...
namespace AppMvc.Net.Areas_Files_Controllers_
{
    ...
    public class FileManagerController : Controller
    {
        ...
        private Connector GetConnector()
        {
            ...
            // string url = $"{uri.Scheme}://{uri.Authority}/D:/ASP.NetCore/ASP/AppMvc.Net/Uploads/";  => cách này cũng ok 
            string url = $"{uri.Scheme}://{uri.Authority}/{requestUrl}/";
            string urlthumb = $"{uri.Scheme}://{uri.Authority}/file-manage-thumb/";
